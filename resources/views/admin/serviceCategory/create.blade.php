                ...
                <div class="row">
                    <div class="col-lg-12 col-xl-8 offset-xl-2">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="Nhập tên danh mục" >
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('description') is-invalid @enderror" id="description" name="description" value="{{ old('description') }}" placeholder="Mô tả" >
                            @error('description')
                                <div class="text-danger mt-2" id="name-error">{{ $message }}</div>
                            @enderror
                        </div>
                        <button type="submit" class="btn btn-primary mb-4">Tạo Danh mục</button>
                    </div>
                </div>
            </form>
        </div>
